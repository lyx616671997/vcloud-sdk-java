package com.bytedanceapi.helper;

public class Const {

    public static final String ACCESS_KEY = "VCLOUD_ACCESSKEY";
    ...
    public static final String REGION_I18N = "us-east-2";
    ...
    public static final String INNER_REGION_I18N = "us-east-2-inner";
